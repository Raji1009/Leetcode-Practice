<h2><a href="https://leetcode.com/problems/tag-validator/description/">591. Tag Validator</a></h2><h3>Hard</h3><hr><p>Given a string representing a code snippet, implement a tag validator to parse the code and return whether it is valid.</p>
